...
\preambulo{Tese apresentada à Escola de Comunicação e Artes da Universidade de São Paulo para obtenção do título de Doutora em Música. Área de concentração: Processos de Criação Musical.}
...
\begin{fichacatalografica}
	...
	\hspace{0.5cm}
		...
		IV. Experimentos em interação musical.			
	\end{minipage}}
	\end{center}
\end{fichacatalografica}
% ---
...
\begin{folhadeaprovacao}
  ...
  \begin{center}
   ...
   Trabalho aprovado. São Paulo,    de           de 2019:
%
...
%que envolveram testes com usuários, análises de dados, análises temáticas, aplicações práticas em performances solo, em grupo ou com participação da audiência em uma série de eventos. Os projetos desenvolvidos apresentam também possíveis desdobramentos futuros, ao sugerir novas direções de pesquisa nesse campo.




%O presente artigo apresenta alguns dos resultados obtidos de uma pesquisa de pesquisa prática em desenvolvimento de interfaces para prática musical baseados em tecnologias web. Mais especificamente, apresentaremos aqui os projetos “Banda Aberta” e “Playsound.space”, desenvolvidos pela autora durante sua pesquisa de doutorado em Sonologia, que procurava testar os potenciais das tecnologias web a criação de interfaces experimentais e acessíveis para produção musical.
