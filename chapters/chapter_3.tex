...
\begin{lstlisting}[caption={Extrato do log de mensagens do servidor do Banda Aberta.},label={lst:msgs}]
...
\begin{figure}[ht!]
\centering
\includegraphics[width=1\linewidth]{pictures/wordcloud_performances}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=1\linewidth]{pictures/wordcloud_pb}
\caption{Nuvem de tags gerada pelas palavras utilizadas nas performances analisadas. (Gerada pela autora utilizando a ferramenta Word Cloud).}
\label{fig:cloud}
\end{figure}
