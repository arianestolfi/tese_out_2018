...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{pictures/utopia}
...
\begin{figure}[hb!]
\centering
\includegraphics[width=1\linewidth]{pictures/cap4/diagram-cannibal}
...
http://www.playsound.space/sounds=386440,351623,339821,316025,148571,176494,396483,427086,232131,296145,148505,148508,409480,176504,351327

sound: Hand Bells, Reverse Cluster.wav by: InspectorJ; sound: PIANO_MED_F5.wav by: neatonk; sound: Piano key F3 by: Goup_1; sound: PIANO_LOUD_F5.wav by: neatonk; sound: PIANO_LOUD_F6.wav by: neatonk; sound: Piano Key G#6 by: Goup_1;
